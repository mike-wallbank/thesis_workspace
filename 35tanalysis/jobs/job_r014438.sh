...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014438
cd ${_CONDOR_SCRATCH_DIR}/EW/014438
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014438 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014438

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014438
