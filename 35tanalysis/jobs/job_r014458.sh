...
mkdir -p ${_CONDOR_SCRATCH_DIR}/both/014458
cd ${_CONDOR_SCRATCH_DIR}/both/014458
...
rm -f lbne_r014458_sr01_20160303T234837.root
copyfile -r ${_CONDOR_SCRATCH_DIR}/both/014458 /dune/data/users/wallbank/Sliced_And_Filtered/both/014458

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/both/014458
