...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014442
cd ${_CONDOR_SCRATCH_DIR}/EW/014442
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014442 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014442

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014442
