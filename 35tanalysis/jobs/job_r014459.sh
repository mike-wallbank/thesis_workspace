...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014459
cd ${_CONDOR_SCRATCH_DIR}/EW/014459
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014459 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014459

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014459
