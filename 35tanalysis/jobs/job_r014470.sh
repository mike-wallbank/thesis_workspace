...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014470
cd ${_CONDOR_SCRATCH_DIR}/EW/014470
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014470 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014470

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014470
