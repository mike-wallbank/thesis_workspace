...
echo Start of analysing run 014468
...
mkdir -p ${_CONDOR_SCRATCH_DIR}/both/014468
cd ${_CONDOR_SCRATCH_DIR}/both/014468
...
copyfile /pnfs/lbne/pnfs/fnal.gov/usr/lbne/test-data/lbne/raw/00/63/89/00/lbne_r014468_sr01_20160304T001434.root .
...
# run the jobs
lar -c SliceAndFilter.fcl -s lbne_r014468_sr01_20160304T001434.root -o sliced_and_filtered.root
lar -c reco_dune35tdata.fcl -s sliced_and_filtered.root -o reco.root
lar -c apa_crossing.fcl -s reco.root

# copy output files back
rm -f lbne_r014468_sr01_20160304T001434.root
copyfile -r ${_CONDOR_SCRATCH_DIR}/both/014468 /dune/data/users/wallbank/Sliced_And_Filtered/both/014468

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/both/014468
