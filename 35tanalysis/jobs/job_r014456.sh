...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014456
cd ${_CONDOR_SCRATCH_DIR}/EW/014456
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014456 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014456

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014456
