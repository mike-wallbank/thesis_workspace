...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014437
cd ${_CONDOR_SCRATCH_DIR}/EW/014437
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014437 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014437

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014437
