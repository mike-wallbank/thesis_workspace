...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014445
cd ${_CONDOR_SCRATCH_DIR}/EW/014445
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014445 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014445

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014445
