...
#
umask 002
# /fife/local/scratch/uploads/dune/wallbank/2016-10-25_040607.686516_4493/do_obtain_analyse_files.sh_20161025_040608_867739_0_1_wrap.sh
# Automatically generated by: 
#          jobsub -l +JobsubClientDN="/DC=org/DC=cilogon/C=US/O=Fermi National Accelerator Laboratory/OU=People/CN=Michael Wallbank/CN=UID:wallbank" -l +JobsubClientIpAddress="131.225.67.240" -l +Owner="wallbank" -l +JobsubServerVersion="1.2.2.1" -l +JobsubClientVersion="1.2.2" -l +JobsubClientKerberosPrincipal="wallbank@FNAL.GOV" -N 1 -e MRB_INSTALL -e MRB_DIR -e RUNFILE -e FILTER -e OUTPUTDIRTAG -e OUTDIR --use_gftp --resource-provides=usage_model=OPPORTUNISTIC /fife/local/scratch/uploads/dune/wallbank/2016-10-25_040607.686516_4493/do_obtain_analyse_files.sh 
...
export JOBSUB_EXE_SCRIPT=`find . -name do_obtain_analyse_files.sh -print`
chmod +x $JOBSUB_EXE_SCRIPT
${JSB_TMP}/ifdh.sh log "wallbank:BEGIN EXECUTION $JOBSUB_EXE_SCRIPT   
 "
...
echo `date` BEGIN EXECUTION $JOBSUB_EXE_SCRIPT   
>&2 echo `date` BEGIN EXECUTION $JOBSUB_EXE_SCRIPT   
$JOBSUB_EXE_SCRIPT   
JOB_RET_STATUS=$?
...
${JSB_TMP}/ifdh.sh log "wallbank:do_obtain_analyse_files.sh COMPLETED with return code $JOB_RET_STATUS" 
exit $JOB_RET_STATUS
