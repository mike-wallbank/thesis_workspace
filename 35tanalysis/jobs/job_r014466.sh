...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014466
cd ${_CONDOR_SCRATCH_DIR}/EW/014466
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014466 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014466

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014466
