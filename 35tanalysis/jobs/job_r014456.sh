...
echo Start of analysing run 014456
...
mkdir -p ${_CONDOR_SCRATCH_DIR}/both/014456
cd ${_CONDOR_SCRATCH_DIR}/both/014456
...
copyfile /pnfs/lbne/pnfs/fnal.gov/usr/lbne/test-data/lbne/raw/00/63/84/50/lbne_r014456_sr01_20160303T234342.root .
...
# run the jobs
lar -c SliceAndFilter.fcl -s lbne_r014456_sr01_20160303T234342.root -o sliced_and_filtered.root
lar -c reco_dune35tdata.fcl -s sliced_and_filtered.root -o reco.root
lar -c apa_crossing.fcl -s reco.root

# copy output files back
rm -f lbne_r014456_sr01_20160303T234342.root
copyfile -r ${_CONDOR_SCRATCH_DIR}/both/014456 /dune/data/users/wallbank/Sliced_And_Filtered/both/014456

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/both/014456
