...
if [ -e /pnfs/dune/scratch/users/wallbank/$1/mva_nue_dune10kt_1x2x6/mva_nue.root ]
then
    echo "File at /pnfs/dune/scratch/users/wallbank/$1/mva_nue_dune10kt_1x2x6/mva_nue.root already exists... overwrite? [y/n] "
    read answer
    if [ $answer != "y" ]
    then
	exit
