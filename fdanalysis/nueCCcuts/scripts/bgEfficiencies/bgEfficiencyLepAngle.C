{
  ...
  TString output_name = "mybgefficiencyLepAngle"; //No postfix (e.g. .root)
  const int NPlots = 2;
  int NBins = 20;
  double binLow = 0.;
  double binHigh = 180;
  ...
  hist_names[0]="h_all";
  selections[0]=(TString)(DEF_BACKGROUND_WEIGHTED);
  draws[0]="LepNuAngle/3.14159265359*180.";
  xaxis_labels[0]="Lepton angle to neutrino (degrees)";
  ...
  draws[1]="LepNuAngle/3.14159265359*180.";
  xaxis_labels[1]="Lepton angle to neutrino (degrees)";
