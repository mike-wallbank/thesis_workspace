...
mkdir -p ${_CONDOR_SCRATCH_DIR}/both/014444
cd ${_CONDOR_SCRATCH_DIR}/both/014444
...
rm -f lbne_r014444_sr01_20160303T225238.root
copyfile -r ${_CONDOR_SCRATCH_DIR}/both/014444 /dune/data/users/wallbank/Sliced_And_Filtered/both/014444

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/both/014444
