...
mkdir -p ${_CONDOR_SCRATCH_DIR}/both/014452
cd ${_CONDOR_SCRATCH_DIR}/both/014452
...
rm -f lbne_r014452_sr01_20160303T232036.root
copyfile -r ${_CONDOR_SCRATCH_DIR}/both/014452 /dune/data/users/wallbank/Sliced_And_Filtered/both/014452

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/both/014452
