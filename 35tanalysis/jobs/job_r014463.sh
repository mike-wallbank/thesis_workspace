...
mkdir -p ${_CONDOR_SCRATCH_DIR}/both/014463
cd ${_CONDOR_SCRATCH_DIR}/both/014463
...
rm -f lbne_r014463_sr01_20160304T000219.root
copyfile -r ${_CONDOR_SCRATCH_DIR}/both/014463 /dune/data/users/wallbank/Sliced_And_Filtered/both/014463

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/both/014463
