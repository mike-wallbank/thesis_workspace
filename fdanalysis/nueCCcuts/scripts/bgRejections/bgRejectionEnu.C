{
  ...
  TString output_name = "myBGRejectionEnu"; //No postfix (e.g. .root)
  const int NPlots = 2;
  int NBins = 20;
  double binLow = 0.;
  double binHigh = 10.;
  ...
  hist_names[0]="h_all";
  selections[0]=(TString)(DEF_SELECTION_ALL_BACKGROUND_WEIGHTED);
  draws[0]="NuMomT";
  xaxis_labels[0]="Neutrino energy (GeV)";
  ...
  selections[1]=(TString)(DEF_REJECTION_SEEN_BACKGROUND_WEIGHTED);
  draws[1]="NuMomT";
  xaxis_labels[1]="Neutrino energy (GeV)";
