...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014453
cd ${_CONDOR_SCRATCH_DIR}/EW/014453
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014453 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014453

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014453
