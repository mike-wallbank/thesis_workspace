...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014443
cd ${_CONDOR_SCRATCH_DIR}/EW/014443
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014443 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014443

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014443
