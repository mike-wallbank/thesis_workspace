...
echo Start of analysing run 014450
...
mkdir -p ${_CONDOR_SCRATCH_DIR}/both/014450
cd ${_CONDOR_SCRATCH_DIR}/both/014450
...
copyfile /pnfs/lbne/pnfs/fnal.gov/usr/lbne/test-data/lbne/raw/00/63/78/51/lbne_r014450_sr01_20160303T230826.root .
...
# run the jobs
lar -c SliceAndFilter.fcl -s lbne_r014450_sr01_20160303T230826.root -o sliced_and_filtered.root
lar -c reco_dune35tdata.fcl -s sliced_and_filtered.root -o reco.root
lar -c apa_crossing.fcl -s reco.root

# copy output files back
rm -f lbne_r014450_sr01_20160303T230826.root
copyfile -r ${_CONDOR_SCRATCH_DIR}/both/014450 /dune/data/users/wallbank/Sliced_And_Filtered/both/014450

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/both/014450
