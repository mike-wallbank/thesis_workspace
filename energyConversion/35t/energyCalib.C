...
class EMEnergyCalibStudy {
public:

  EMEnergyCalibStudy(TTree* tree);
  ~EMEnergyCalibStudy();
...
EMEnergyCalibStudy::~EMEnergyCalibStudy() {
  outFile->Close();
  delete outFile;
}

double EMEnergyCalibStudy::ConvertChargeToEnergy(double charge, int plane) {
...
void EMEnergyCalibStudy::SetBranchAddresses() {
...
void EMEnergyCalibStudy::MakeFits() {
...
void EMEnergyCalibStudy::ProcessEvent() {
...
void EMEnergyCalibStudy::SaveHists() {
...
void energyCalib() {
  ...
  EMEnergyCalibStudy emenergycalib = EMEnergyCalibStudy(tree);
  emenergycalib.Run();
