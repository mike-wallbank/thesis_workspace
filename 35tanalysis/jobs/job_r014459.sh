...
echo Start of analysing run 014459
...
mkdir -p ${_CONDOR_SCRATCH_DIR}/both/014459
cd ${_CONDOR_SCRATCH_DIR}/both/014459
...
copyfile /pnfs/lbne/pnfs/fnal.gov/usr/lbne/test-data/lbne/raw/00/63/81/52/lbne_r014459_sr01_20160303T235122.root .
...
# run the jobs
lar -c SliceAndFilter.fcl -s lbne_r014459_sr01_20160303T235122.root -o sliced_and_filtered.root
lar -c reco_dune35tdata.fcl -s sliced_and_filtered.root -o reco.root
lar -c apa_crossing.fcl -s reco.root

# copy output files back
rm -f lbne_r014459_sr01_20160303T235122.root
copyfile -r ${_CONDOR_SCRATCH_DIR}/both/014459 /dune/data/users/wallbank/Sliced_And_Filtered/both/014459

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/both/014459
