...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014457
cd ${_CONDOR_SCRATCH_DIR}/EW/014457
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014457 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014457

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014457
