...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014468
cd ${_CONDOR_SCRATCH_DIR}/EW/014468
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014468 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014468

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014468
