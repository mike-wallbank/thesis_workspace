void purity(TString inputname, TString outputname="hists_purities.root",TString mvacut="0.8",TString friendfile=""){
  ...
  //TString SELECTION="mvaresult>-0.1";
  ...
  MVASelection->Draw("Ev >> h_enu_sig",WEIGHTING+"*("+SELECTION+")");
  ...
  h_eff_enu->SetTitle(TString("eff;")+h_enu_sig->GetXaxis()->GetTitle()+TString(";#nu_{#mu}#rightarrow#mu purity (No units)"));
  //h_eff_enu->Draw();
  ...
  h_eff_q2->SetTitle(TString("eff;")+h_q2_sig->GetXaxis()->GetTitle()+TString(";#nu_{#mu}#rightarrow#mu purity (No units)"));
  ...
  h_eff_lepangle->SetTitle(TString("eff;")+h_lepangle_sig->GetXaxis()->GetTitle()+TString(";#nu_{#mu}#rightarrow#mu purity (No units)"));
  ...
  h_eff_lepmom->SetTitle(TString("eff;")+h_lepmom_sig->GetXaxis()->GetTitle()+TString(";#nu_{#mu}#rightarrow#mu purity (No units)"));
