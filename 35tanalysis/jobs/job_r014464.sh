...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014464
cd ${_CONDOR_SCRATCH_DIR}/EW/014464
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014464 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014464

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014464
