...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014434
cd ${_CONDOR_SCRATCH_DIR}/EW/014434
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014434 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014434

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014434
