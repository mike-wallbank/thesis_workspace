void effPurOverlay(TString efficiency_file_name, TString purity_file_name, TString bg_efficiency_file_name="", TString output_prefix="output"){
  ...
  TLegend *leg_enu = new TLegend(0.55,0.5,0.88,0.76);
  ...
  TLegend *leg_q2 = new TLegend(0.55,0.25,0.88,0.51);
  ...
  TLegend *leg_lepmom = new TLegend(0.55,0.5,0.88,0.76);//0.595,0.246,0.885,0.417);
