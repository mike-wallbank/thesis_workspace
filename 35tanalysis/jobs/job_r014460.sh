...
echo Start of analysing run 014460
...
mkdir -p ${_CONDOR_SCRATCH_DIR}/both/014460
cd ${_CONDOR_SCRATCH_DIR}/both/014460
...
copyfile /pnfs/lbne/pnfs/fnal.gov/usr/lbne/test-data/lbne/raw/00/63/83/01/lbne_r014460_sr01_20160303T235344.root .
...
# run the jobs
lar -c SliceAndFilter.fcl -s lbne_r014460_sr01_20160303T235344.root -o sliced_and_filtered.root
lar -c reco_dune35tdata.fcl -s sliced_and_filtered.root -o reco.root
lar -c apa_crossing.fcl -s reco.root

# copy output files back
rm -f lbne_r014460_sr01_20160303T235344.root
copyfile -r ${_CONDOR_SCRATCH_DIR}/both/014460 /dune/data/users/wallbank/Sliced_And_Filtered/both/014460

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/both/014460
