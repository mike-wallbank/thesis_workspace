...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014449
cd ${_CONDOR_SCRATCH_DIR}/EW/014449
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014449 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014449

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014449
