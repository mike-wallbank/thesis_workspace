...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014440
cd ${_CONDOR_SCRATCH_DIR}/EW/014440
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014440 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014440

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014440
