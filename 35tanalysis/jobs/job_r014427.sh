...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014427
cd ${_CONDOR_SCRATCH_DIR}/EW/014427
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014427 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014427

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014427
