...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014428
cd ${_CONDOR_SCRATCH_DIR}/EW/014428
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014428 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014428

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014428
