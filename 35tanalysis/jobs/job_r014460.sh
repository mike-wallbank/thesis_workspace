...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014460
cd ${_CONDOR_SCRATCH_DIR}/EW/014460
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014460 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014460

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014460
