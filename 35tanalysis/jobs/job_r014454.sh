...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014454
cd ${_CONDOR_SCRATCH_DIR}/EW/014454
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014454 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014454

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014454
