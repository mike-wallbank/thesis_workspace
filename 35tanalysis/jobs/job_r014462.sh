...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014462
cd ${_CONDOR_SCRATCH_DIR}/EW/014462
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014462 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014462

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014462
