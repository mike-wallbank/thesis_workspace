...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014469
cd ${_CONDOR_SCRATCH_DIR}/EW/014469
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014469 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014469

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014469
