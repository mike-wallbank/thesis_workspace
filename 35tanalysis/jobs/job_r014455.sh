...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014455
cd ${_CONDOR_SCRATCH_DIR}/EW/014455
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014455 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014455

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014455
