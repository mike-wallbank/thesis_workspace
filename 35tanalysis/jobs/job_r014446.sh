...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014446
cd ${_CONDOR_SCRATCH_DIR}/EW/014446
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014446 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014446

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014446
