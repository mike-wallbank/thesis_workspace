...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014447
cd ${_CONDOR_SCRATCH_DIR}/EW/014447
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014447 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014447

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014447
