...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014450
cd ${_CONDOR_SCRATCH_DIR}/EW/014450
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014450 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014450

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014450
