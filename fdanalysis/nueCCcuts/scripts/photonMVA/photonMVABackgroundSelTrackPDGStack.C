{
  ...
  //Simple script to draw PhotonMVA for photons and not photons
  ...
  hist_names[0]="h_photons";
  selections[0]=(TString)("");
  selections[0] = (TString)("(("+DEF_WEIGHTING+")*(("+DEF_BACKGROUND+")&&("+DEF_SELECTION+"&&abs(SelTruePDG)==13)))");
  draws[0]="SelMVAPhoton";
  xaxis_labels[0]="Photon-like MVA (no units)";
  ...
  selections[1] = (TString)("(("+DEF_WEIGHTING+")*(("+DEF_BACKGROUND+")&&("+DEF_SELECTION+"&&abs(SelTruePDG)==2212)))");
  draws[1]="SelMVAPhoton";
  xaxis_labels[1]="Photon-like MVA (no units)";
  ...
  selections[2] = (TString)("(("+DEF_WEIGHTING+")*(("+DEF_BACKGROUND+")&&("+DEF_SELECTION+"&&abs(SelTruePDG)==211)))");
  draws[2]="SelMVAPhoton";
  xaxis_labels[2]="Photon-like MVA (no units)";
  ...
  selections[3] = (TString)("(("+DEF_WEIGHTING+")*(("+DEF_BACKGROUND+")&&("+DEF_SELECTION+"&&(!((abs(SelTruePDG)==13)||abs(SelTruePDG==2212)||abs(SelTruePDG)==211)))))");
  draws[3]="SelMVAPhoton";
  xaxis_labels[3]="Photon-like MVA (no units)";
