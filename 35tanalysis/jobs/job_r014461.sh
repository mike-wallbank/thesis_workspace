...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014461
cd ${_CONDOR_SCRATCH_DIR}/EW/014461
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014461 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014461

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014461
