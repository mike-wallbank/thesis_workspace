...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014436
cd ${_CONDOR_SCRATCH_DIR}/EW/014436
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014436 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014436

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014436
