...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014467
cd ${_CONDOR_SCRATCH_DIR}/EW/014467
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014467 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014467

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014467
