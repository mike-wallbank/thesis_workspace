...
mkdir -p ${_CONDOR_SCRATCH_DIR}/EW/014439
cd ${_CONDOR_SCRATCH_DIR}/EW/014439
...
copyfile -r ${_CONDOR_SCRATCH_DIR}/EW/014439 /dune/data/users/wallbank/Sliced_And_Filtered/EW/014439

# remove the temp directory
rm -rf ${_CONDOR_SCRATCH_DIR}/EW/014439
